...
use App\Exception\InvalidElementException;
...
class Filter
{
     ...
     * @throws \App\Exception\InvalidElementException
     * @return mixed
     */
    public static function getFilterInstance($class, array $args = array(), array $namespaces = array())
    {
        $namespaces = array_merge($namespaces, array('', '\\App\\Filter', '\\Zend\\Filter'));
        ...
        throw new InvalidElementException("Filter class not found");
    }
}